...
function App() {
    ...
    useEffect(() => {
        ...
        if (!isComplete) {
            handleToastify("Health record is incomplete. Redirecting to input page.", "error");
        }
    }, [isComplete]);
    ...
    return (
        ...
        style={{ height: "100%" }}>
            ...
            <div className="mt-3 d-flex justify-content-center align-items-center gap-3">
                <button className="custom-btn fs-5">Lưu bản ghi <FontAwesomeIcon icon={faDatabase} /></button>
