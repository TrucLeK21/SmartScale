...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  final List<String> _raceOptions = ['Phương đông', 'Phương tây'];
    ...
    try {
      ...
      if (profile != null) {
        setState(() {
          ...
          _selectedRace = user?.race == "" ? "asian" : user?.race;
          ...
          child: Column(
            ...
            // Chủng tộc
              DropdownButtonFormField<String>(
                ...
                value: _selectedRace == "asian" ? "Phương đông" : "Phương tây",
                items: _raceOptions
                    .map((gender) => DropdownMenuItem(
                          value: gender,
                          child: Text(gender),
                ...
                onChanged: (value) {
                  setState(() {
                    _selectedRace = value == "Phương đông" ? "asian" : "caucasian";
                  });
                },
                validator: (value) {
                  if (value == null || value.isEmpty) {
